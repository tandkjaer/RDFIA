...
last edited: 08/05/2019, by stanhope
edited: tweaked nearAOs for molos airfield
*/
...
class AOs{
	class AAC_Airfield {
		...
		vehicles[] =
		{
			{"O_T_VTOL_02_infantry_dynamicLoadout_F", "aac_heli1",900},
...
/*	class Aggelorchori_Factory {
	...
	class Molos_Airfield {
		...
		vehicles[] =
		{
			...
			{"B_MBT_01_cannon_F", "mol_veh1",1800},
