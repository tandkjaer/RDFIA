...
Last edited: 13/5/19 by stanhope
Edit: code cleanup
...
params ["_vehChosen","_NotAReward", "_movePos"];

/*
A reward will be picked from this array, first entry is the display name, second the actual reward.
...
smRewards = [
    ...
    ['To-201 Shikra','O_Plane_Fighter_02_F'],
    ['To-201 Shikra (Stealth)','O_Plane_Fighter_02_Stealth_F'],
    ...
    //attack helis (9)
	['Y-32 (Vehicle Transport, armed)', 'O_T_VTOL_02_vehicle_dynamicLoadout_F'],
    ...
    //transport helis (10)
    ['an MI-290 Taru (Transport)', 'O_Heli_Transport_04_covered_black_F'],
    ['an MI-290 Taru (Transport)', 'O_Heli_Transport_04_covered_black_F'],
    ['an MI-290 Taru (Bench)', 'O_Heli_Transport_04_bench_black_F'],
    ['an MI-290 Taru (Bench)', 'O_Heli_Transport_04_bench_black_F'],
	['an MI-290 Taru (heavy lifter)', 'O_Heli_Transport_04_black_F'],
	['an MI-290 Taru (heavy lifter)', 'O_Heli_Transport_04_black_F'],
    ['an Y-32 (Infantry Transport, unarmed)', 'O_T_VTOL_02_infantry_dynamicLoadout_F'],
    ['an Y-32 (Infantry Transport, unarmed)', 'O_T_VTOL_02_infantry_dynamicLoadout_F'],
    ['an Y-32 (Infantry Transport, unarmed)', 'O_T_VTOL_02_infantry_dynamicLoadout_F'],
	['an Y-32 (Infantry Transport, unarmed)', 'O_T_VTOL_02_infantry_dynamicLoadout_F'],
    ...
    ['an enhanced AMV-7 Marshall', 'Land_Pipe_fence_4m_F'],
    ['an enhanced AMV-7 Marshall', 'Land_Pipe_fence_4m_F'],
	['an AWC 301 Nyx (AT)', 'I_LT_01_AT_F'],
	['an AWC 301 Nyx (AT)', 'I_LT_01_AT_F'],
	['an AWC 301 Nyx (AT)', 'I_LT_01_AT_F'],
	['an AWC 303 Nyx (Recon)', 'I_LT_01_scout_F'],
	['an AWC 304 Nyx (Autocannon)', 'I_LT_01_cannon_F'],
	['an AWC 304 Nyx (Autocannon)', 'I_LT_01_cannon_F'],
	['an AWC 304 Nyx (Autocannon)', 'I_LT_01_cannon_F'],
	['a Rhino MGS', 'B_AFV_Wheeled_01_cannon_F'],
	['a Rhino MGS', 'B_AFV_Wheeled_01_cannon_F'],
	['a Rhino MGS', 'B_AFV_Wheeled_01_cannon_F'],
	['an up-armored Rhino MGS', 'B_AFV_Wheeled_01_up_cannon_F'],
	['an up-armored Rhino MGS', 'B_AFV_Wheeled_01_up_cannon_F'],
    ...
    ['an IFV-6a Cheetah', 'B_APC_Tracked_01_AA_F'],
	['an IFV-6a Cheetah', 'B_APC_Tracked_01_AA_F'],
	['an AWC 302 Nyx (AA)', 'I_LT_01_AA_F'],
	['an AWC 302 Nyx (AA)', 'I_LT_01_AA_F'],
	['an AWC 302 Nyx (AA)', 'I_LT_01_AA_F'],
	['an AWC 302 Nyx (AA)', 'I_LT_01_AA_F'],
	['an AWC 302 Nyx (AA)', 'I_LT_01_AA_F'],
	['ZSU-39 Tigris','O_APC_Tracked_02_AA_F'],
	['ZSU-39 Tigris','O_APC_Tracked_02_AA_F'],
	['ZSU-39 Tigris','O_APC_Tracked_02_AA_F'],
	['ZSU-39 Tigris','O_APC_Tracked_02_AA_F'],
	['ZSU-39 Tigris','O_APC_Tracked_02_AA_F'],
    ...
    //Cars (54)
    ['an Offroad (AT, spg-9)', 'B_G_Offroad_01_AT_F'],
	['an Offroad (AT, spg-9)', 'B_G_Offroad_01_AT_F'],
	['an Offroad (AT, titan)', 'Sign_Arrow_Blue_F'],
    ['an Offroad (AT, titan)', 'Sign_Arrow_Blue_F'],
	...
	['MB 4WD (AT)','I_C_Offroad_02_AT_F'],
	['MB 4WD (AT)','I_C_Offroad_02_AT_F'],
	['MB 4WD (LMG)','I_C_Offroad_02_LMG_F'],
	['MB 4WD (LMG)','I_C_Offroad_02_LMG_F'],
	['a Qilin (Armed)', 'O_LSV_02_armed_F'],
    ['a Qilin (Armed)', 'O_LSV_02_armed_F'],
	['Prowler (AT)','B_LSV_01_AT_F'],
	['Prowler (AT)','B_LSV_01_AT_F'],
	['Qilin (AT)', 'O_LSV_02_AT_F'],
	['Qilin (AT)', 'O_LSV_02_AT_F'],
...
if (isNil "InAPreviousSMReward") then {
	InAPreviousSMReward = smRewards select 1 select 1;
};
...
if (isNil "_vehChosen") then {	
	...
	while{ (_veh select 1) == InAPreviousSMReward } do {
		_veh = selectRandom smRewards;
	};
}else{	
	_veh = _vehChosen ;
...
switch (typeOf _reward) do {
    case "B_Plane_CAS_01_dynamicLoadout_F" : { //an A-164 Wipeout (CAS)
    ...
    case "B_Plane_Fighter_01_F": { //an F/A-181 Black Wasp II
    	...
    	_reward setVehicleReportRemoteTargets true;
    };
    ...
    case "B_Heli_Light_01_dynamicLoadout_F": {//an AH-9 Pawnee
        private _skin = selectRandom [
    ...
    case "I_Heli_light_03_dynamicLoadout_F": { //Hellcat
    ...
    case "O_T_VTOL_02_infantry_dynamicLoadout_F": { //an Y-32 Xi'an (Infantry Transport, unarmed)
        for "_i" from 0 to 5 do {
            _reward setPylonLoadOut [_i, "",false,[]];
        };
    	...
    	_reward setVehicleReportRemoteTargets true;
        {
            _reward setObjectTextureGlobal [_forEachIndex, _x];
	...
	case "O_T_VTOL_02_vehicle_dynamicLoadout_F": {
		...
		_reward setPylonLoadOut [1, _weaponOuter,false,[0]];
		_reward setPylonLoadOut [4, _weaponOuter,false,[0]];
    ...
    case "Land_VR_CoverObject_01_standHigh_F": {//a hemtt mounted Mk49 Spartan
    	deleteVehicle _reward;
    	_reward = createVehicle ["B_Truck_01_mover_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	_reward setDir 0;
    ...
    case "Land_W_sharpStone_01": { //enhanced t-100
    	deleteVehicle _reward;
    	...
    	_reward addMagazineTurret ["16Rnd_125mm_APFSDS_T_Green",[0]];
    	_reward addMagazineTurret ["12Rnd_125mm_HEAT_T_Green",[0]];
    	_reward addMagazineTurret ["12Rnd_125mm_HE_T_Green",[0]];
    };
    case "Land_BluntStones_erosion": { //enhanced kuma
    	deleteVehicle _reward;
    ...
    case "Land_W_sharpStone_02": {//enhanced slammer
    	deleteVehicle _reward;
    ...
    case "O_MBT_04_command_F"; //t-140 and t-140k
    ...
    case "Land_PipeWall_concretel_8m_F": {
        deleteVehicle _reward;
    ...
    case "I_LT_01_cannon_F": {
        [_reward,["Indep_Olive",1]] call BIS_fnc_initVehicle;
    };
    case "OfficeTable_01_new_F": {//a Minigun bobcat
    	deleteVehicle _reward;
    	_reward = createVehicle ["B_APC_Tracked_01_CRV_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	_reward removeMagazine ("2000Rnd_65x39_belt");
    	_reward removeMagazine ("2000Rnd_65x39_belt");
    ...
    case "Land_RattanTable_01_F": { //a Hunter Minigun
    	deleteVehicle _reward;
    ...
    case "OfficeTable_01_old_F": { //a strider Minigun
    	deleteVehicle _reward;
    ...
    case "Land_Graffiti_02_F": {//a Lynx Strider
    	deleteVehicle _reward;
    	_reward = createVehicle ["I_MRAP_03_hmg_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	_reward removeMagazine ("200Rnd_127x99_mag_Tracer_Yellow");
    	_reward removeMagazine ("200Rnd_127x99_mag_Tracer_Yellow");
    ...
    case "Land_Sun_chair_F": {//hunter (titan)
    	deleteVehicle _reward;
    	_reward removeMagazine ("96Rnd_40mm_G_belt");
    	_reward removeMagazine ("96Rnd_40mm_G_belt");
    	_reward = createVehicle ["B_MRAP_01_gmg_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	_reward removeWeapon "GMG_40mm";
    	_reward addWeapon "missiles_titan_static";
    	for "_i" from 1 to 6 do { _reward addMagazine ("1Rnd_GAT_missiles"); };
    };
    case "O_T_LSV_02_armed_F";
    case "O_LSV_02_AT_F";
    case "O_LSV_02_armed_F": { // qilin
    ...
    case "Land_TableDesk_F": { //a Minigun offroad
    	deleteVehicle _reward;
    	_reward = createVehicle ["B_G_Offroad_01_armed_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	for "_i" from 1 to 4 do{_reward removeMagazine ("100Rnd_127x99_mag_Tracer_Yellow");};
    ...
    case "Sign_Arrow_Blue_F": {//an Offroad (AT)
    	deleteVehicle _reward;
    	_reward = createVehicle ["B_G_Offroad_01_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	_reward setDir 0;
    	private _ATLauncher = createVehicle ["B_static_AT_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    ...
    case "Sign_Arrow_Cyan_F": {//an Offroad (AA)
    	deleteVehicle _reward;
    	_reward = createVehicle ["B_G_Offroad_01_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	_reward setDir 0;
    	private _AALauncher = createVehicle ["B_static_AA_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    ...
    case "B_G_Offroad_01_repair_F": {//a Mobile Mortar Truck
    	private _mortar = createVehicle ["B_Mortar_01_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    ...
    case "Land_InfoStand_V1_F": { //an Offroad (Armed GMG)
    	deleteVehicle _reward;
    	_reward = createVehicle ["B_G_Offroad_01_repair_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    	private _GMG = createVehicle ["B_GMG_01_high_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
    ...
    case "O_APC_Tracked_02_AA_F":{
    	for "_i" from 0 to 2 do {_reward setObjectTextureGlobal [_i,"#(argb,8,8,3)color(0.1,0.1,0.1,1)"];};
    };

    case "C_Tractor_01_F": {
        private _GMG = createVehicle ["B_HMG_01_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
        _GMG attachTo [_reward,[0,-0.8,2]];
        _GMG enableWeaponDisassembly false;
        {_x addCuratorEditableObjects [[_reward,_GMG], false];} forEach allCurators;
    };
};
...
if (_reward isKindOf "Plane") then {
	...
	if (_reward isKindOf "B_T_VTOL_01_armed_F" || _reward isKindOf "B_T_VTOL_01_infantry_F") then {_tosetpos = [_tosetpos select 0, _tosetpos select 1, (_tosetpos select 2)+4.5];};
	//actually move it
	...
	{
		private _weaponlist = weapons _reward;
...
//Adds any reward that hasn't been altered to zeus

{_x addCuratorEditableObjects [[_reward], true];} forEach allCurators;

//change vehicle inventory
[_reward] spawn AW_fnc_vehicleInventory;

//=====fuel function
[   _reward,
    ["<t color='#1eff65'>Refuel vehicle</t>",{
    if (fuel (_this select 0) < 0.2) then {
        (_this select 0) setFuel 0.2; (_this select 0) vehicleChat "Engineer refueled your vehicle";
    }else {
...
_reward forceFlagTexture "";
_reward setVehicleReceiveRemoteTargets true;

if (_reward isKindOf "UAV") then {
     _reward setVehicleReportRemoteTargets true;
     _reward setVehicleReportOwnPosition true;
};

if ( ! (_reward isKindOf "LandVehicle") ) exitWith {
    if (locked _reward != 0) then {
        _reward lock false;
    };
};

if (((typeOf _reward) find "B_" == -1) || ((typeOf _reward) find "B_G_" != -1)) then {
    _reward forceFlagTexture "\A3\Data_F\Flags\Flag_nato_CO.paa";
};

/*This bit of code was ripped from I&A4, credit goes to ryko*/
private _animationList = getArray (configFile >> "CfgVehicles" >> (typeOf _reward) >> "animationList");
if ( !isNil "_animationList" ) then {

    /*Reset all current animations*/
    private _resetArray = [];
    {
        if (typeName _x == typeName 1) then {
            _resetArray pushBack 0;
        } else {
            _resetArray pushBack _x;
        };
    } forEach _animationList;
    [_reward, [], _resetArray] call BIS_fnc_initVehicle;

    private _applyAnimations = [];
    private _animationsToPickFrom = ["showTools", "showAmmobox", "showBags", "showBags2", "showCanisters"];

    if ("showSLATHull" in _animationList) then {
        /*pick between slats or camo*/
        if (random 1 > 0.5) then {
            _animationsToPickFrom = _animationsToPickFrom + ["showSLATHull", "showSLATTurret"];
        } else {
            _animationsToPickFrom = _animationsToPickFrom + ["showCamonetCannon", "showCamonetCannon1", "showCamonetPlates1", "showCamonetPlates2", "showCamonetHull", "showCamonetTurret"];
        };
    } else {
        /*No slats so just put camo on there*/
        _animationsToPickFrom = _animationsToPickFrom + ["showCamonetCannon", "showCamonetCannon1", "showCamonetPlates1", "showCamonetPlates2", "showCamonetHull", "showCamonetTurret"];
    };

    if ( count _animationList > 0 ) then
    {	{	if ( _x in _animationList ) then
            {	_applyAnimations pushBack _x;
                _applyAnimations pushBack 1;
            };
        } forEach _animationsToPickFrom;
    };
    if ( count _applyAnimations > 0 ) then {	[_reward, [], _applyAnimations] call BIS_fnc_initVehicle; };
};
...
private _pos = [_movePos, 10, 30, 3, 0, 5, 0, [], _movePos] call BIS_fnc_findSafePos;
_reward setPos _pos;

private _eh = _reward addEventHandler ["GetIn", {
    params ["_vehicle"];
    _vehicle setVariable ["RewardWasClaimed", true];
    private _ehIndex = _vehicle getVariable ["claimVehicleEH", (-1)];
    if (_ehIndex != -1) then {
        _vehicle removeEventHandler ["GetIn", _ehIndex];
    };
}];

_reward setVariable ["claimVehicleEH", _eh];
[_reward] spawn {
    params ["_reward"];
    sleep 600;
    if (isNil "_reward") exitWith {};
    if (isNull _reward) exitWith {};
    if (!alive _reward) exitWith {};
    if (_reward getVariable ["RewardWasClaimed", false]) exitWith {};
    private _pos = [getMarkerPos "smReward1", 5, 25, 3, 0, 5, 0, [], getMarkerPos "smReward1"] call BIS_fnc_findSafePos;
    _reward setPos _pos;
};
if (locked _reward != 0) then {
    _reward lock false;
