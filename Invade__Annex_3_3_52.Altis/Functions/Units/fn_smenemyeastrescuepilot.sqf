...
for "_x" from 1 to 2 do {
	...
	sleep 0.1;
	{_x addCuratorEditableObjects [[_SMveh] + units _SMvehPatrol, false];} foreach allCurators;
...
for "_x" from 0 to (1 + (random 2)) do {
	...
	{_x addCuratorEditableObjects [[_SMaa]+units _SMaaPatrol, false];} foreach allCurators;
};
