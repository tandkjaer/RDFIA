...
derp_reviveKeyDownID = (findDisplay 46) displayAddEventHandler ["KeyDown", {
    ...
    if (_key == 1 && {alive player}) then {
        ...
        disableSerialization;
           ...
           _ctrl ctrlSetEventHandler ["buttonClick","{closeDialog 0}; ['KILLED', false, 0, false, false] spawn BIS_fnc_endMission"];
           _ctrl ctrlEnable true;
           _ctrl ctrlSetText "ABORT";
           _ctrl ctrlSetTooltip "Abort.";*/

           _ctrl = _dlg displayctrl ([103, 1010] select isMultiplayer);
