...
Last modified: 16/12/2018 by stanhope

Modified: fixed pos finder + updated missiontype array
*/
...
sideObj addEventHandler ["Killed",{
	...
	_targetStartText = format["<t align='center' size='2.2'>Side mission failed</t><br/><t size='1.5' align='center' color='#FFCF11'>Asset destroyed</t><br/>____________________<br/>%1 destroyed the asset, mission failed.",_name];
...
//-------------------- DE-BRIEFING
    ...
    if (SM_SUCCESS) then {
          [_missionType, nil, _flatPos] call AW_fnc_SMhintSUCCESS;
