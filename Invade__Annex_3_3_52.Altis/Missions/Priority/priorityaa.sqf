...
//-------------------- 2. SPAWN OBJECTIVES & ammo truck(for ambiance and plausibiliy of unlimited ammo)
	...
	_priorityGroup createUnit ["O_officer_F", _flatPos, [], 0, "NONE"];
	...
	createVehicleCrew priorityObj0;
    (crew priorityObj0) join _priorityGroup;
    {
    	private _AAACrew = _priorityGroup createUnit ["O_UAV_AI_F", [0,0,0], [], 0, "NONE"];
        _AAACrew moveInAny _x;
...
sleep 15; //15 seconds so pilots have a chance to get to safety
{
	_x setVehicleAmmo 1;
