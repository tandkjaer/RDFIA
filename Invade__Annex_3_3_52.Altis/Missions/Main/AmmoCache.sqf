...
if (_accepted) then {
	...
	private _targetStartText = format["<t align='center' size='2.2'>Sub-Objective</t><br/><t size='1.5' align='center' color='#FFCF11'>Charges planted</t><br/>____________________<br/>%Charges have been planted on the cache in %1 by %2.  Get clear it will blow in 30 seconds!",_aoName, name _hero];
	[_targetStartText] remoteExec ["AW_fnc_globalHint",0,false];
    ...
    subObjUnits = subObjUnits + _defenders;
